...
$sql=mysql_query("SELECT invoice.noinvoice,nama,alamat,jmlbrg,tanggal,totalbayar,transfer from invoice inner join pelanggan on invoice.idpelanggan=pelanggan.idpelanggan where transfer != '0'");//order by
...
$pdf->Cell(20,6,'Jumlah Barang',1,0,'C');
...
$pdf->setY($y);
	...
	$pdf->Cell(40,6,$data['alamat'],1,0,'L');
	$pdf->Cell(40,6,$data['tanggal'],1,0,'L');
	$pdf->Cell(20,6,$data['jmlbrg'],1,0,'L');
