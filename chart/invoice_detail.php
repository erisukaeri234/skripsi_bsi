...
<a href='index.php?mod=chart&pg=invoice' class='btn btn-warning'>
	...
	<table  class="table table-striped">
		<thead>
			...
			<td><b>Harga Satuan</b></td><td><b>Jumlah</b></td><td><b>Ongkir</b></td><td class='pull-right'><b>Subtotal</b></td></th>
		</thead>
		<tbody>
<?php
$id=$_GET['id'];
$query="SELECT produk.*,detail_invoice.* ,stok.harga_jual
from produk,detail_invoice,stok 
where produk.idproduk=detail_invoice.idproduk
and produk.idproduk=stok.idproduk
and detail_invoice.noinvoice='$id'";
...
$subtotal= $rows -> harga_jual* $rows -> jumlah+$rows -> ongkir;
