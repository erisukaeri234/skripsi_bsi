...
action="pelanggan/pelanggan_action.php">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea name='alamat' class='required'>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" onkeypress='return hanyaAngka(event)' name='kodepos' id='kodepos' value='<?=$data->kodepos?>' class='required'
			>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" onkeypress='return hanyaAngka(event)' name='telp' id='telp' value='<?=$data->telp?>' class='required'
			>
		</div>
	</div>
	<div class="control-group">
