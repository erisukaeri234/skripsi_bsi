    ...
    combo_produk($data->idproduk);
   	?>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" onkeypress='return hanyaAngka(event)' name='harga_beli' id='harga_beli' value='<?=$data->harga_beli?>' class='required'
				>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" onkeypress='return hanyaAngka(event)' name='harga_jual' id='harga_jual' value='<?=$data->harga_jual?>' class='required'
				>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" onkeypress='return hanyaAngka(event)' name='jumlah' id='jumlah' value='<?=$data->jumlah?>' class='required'
				>
			</div>
		</div>
